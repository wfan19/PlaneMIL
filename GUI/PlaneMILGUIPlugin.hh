 ...
 *
*/
#ifndef PLANEMILGUIPLUGIN_HH_
#define PLANEMILGUIPLUGIN_HH_
...
namespace gazebo
{
  ...
  class GZ_PLUGIN_VISIBLE PlaneMILGUIPlugin : public GUIPlugin
  {
    Q_OBJECT
    ...
    private: transport::PublisherPtr RCPub;
