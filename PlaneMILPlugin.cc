...
#include "include/PlaneMILPlugin.hh"

using namespace gazebo;

GZ_REGISTER_MODEL_PLUGIN(PlaneMILPlugin)
...
/////////////////////////////////////////////////
bool PlaneMILPlugin::FindJoint(const std::string &_sdfParam, sdf::ElementPtr _sdf,
...
/////////////////////////////////////////////////
void PlaneMILPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  GZ_ASSERT(_model, "PlaneMILPlugin _model pointer is NULL");
  GZ_ASSERT(_sdf, "PlaneMILPlugin _sdf pointer is NULL");
  this->model = _model;
  ...
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
    std::bind(&PlaneMILPlugin::Update, this, std::placeholders::_1));
  ...
  this->controlSub = this->node->Subscribe(prefix + "control",
    &PlaneMILPlugin::OnControl, this);

  gzlog << "Cessna ready to fly. The force will be with you" << std::endl;
}

/////////////////////////////////////////////////
void PlaneMILPlugin::Update(const common::UpdateInfo &/*_info*/)
{
...
/////////////////////////////////////////////////
void PlaneMILPlugin::OnControl(ConstCessnaPtr &_msg)
{
  std::lock_guard<std::mutex> lock(this->mutex);
...
/////////////////////////////////////////////////
void PlaneMILPlugin::UpdatePIDs(double _dt)
{
...
/////////////////////////////////////////////////
void PlaneMILPlugin::PublishState()
{
