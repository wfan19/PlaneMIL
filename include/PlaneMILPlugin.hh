...
/// This is all based on the CessnaPlugin file included with Gazebo

#ifndef GAZEBO_PLUGINS_PLANEMILPLUGIN_HH_
#define GAZEBO_PLUGINS_PLANEMILPLUGIN_HH_
...
namespace gazebo
{
  ...
  /// "~/<model_name>/state"
  class GZ_PLUGIN_VISIBLE PlaneMILPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: PlaneMILPlugin();
